export const metadata = {
  ...
  alternates: {
    canonical: '/endpoint/embeddings/embeddings'
  }
}
...
<Row>
  ...
  This endpoint is deprecated. Please use the [Search](https://docs.supavec.com/endpoint/retrieval/search) endpoint instead.
