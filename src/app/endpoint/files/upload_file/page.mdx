export const metadata = {
  title: 'Upload File',
  description:
    "This endpoint is used to directly upload PDF, markdown or text files to Supavec. The POST request should be a multipart form request.",
  alternates: {
    canonical: '/endpoint/files/upload_file'
  }
}
...
<Row>
  ...
  <Col>
    ...
    formData.append("file", files[0]); // Accepts PDF (.pdf), markdown (.md) or text (.txt) files
